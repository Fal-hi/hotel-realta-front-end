...
import { doDeleteListDetail } from "@/redux/PURCHASING/action/actionListOrder"

export default function DeleteListOrder(props: any) {
  const dispatch = useDispatch()
  const handleDelete = async (id: any) => {
    dispatch(doDeleteListDetail(props.isDelete.id))
    // console.log(props.isDelete.id)
    props.closeModal()
  }
    ...
    <div>
      <div className="px-5">
        <div>
          ...
          >
            <label>Are you sure to delete this List Detail?</label>
          </div>
