...
const FromAddSaldo = (props: any) => {
  ...
  const handlePresetAmountClick = (event: any) => {
  ...
  useEffect(() => {
    ...
    setValue('targetNumber',props.code);
  }, [])
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <div className="">
              <input
                type="text"
                className="w-full px-4 py-2 border disabled:bg-gray-300 border-gray-400 rounded-md focus:border-indigo-500 focus:outline-none focus:shadow-outline-indigo disabled:cursor-not-allowed"
