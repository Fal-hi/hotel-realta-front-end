              ...
              <div className="relative p-6 flex-auto">
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    className="bg-gray-50 border focus:bg-white placeholder:italic placeholder:text-slate-400 border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-bgPrimary  dark:focus:border-bgPrimary  focus:outline-none focus:border-bgPrimary  focus:ring-bgPrimary  focus:ring-1"
                    required
                    placeholder="+62..."
                  ...
                  {dropdown && (
                    <ul className=" w-full text-sm text-gray-700 mt-2 rounded-lg border dark:text-gray-200 ">
                      <li
                        ...
                        onClick={e => {
                          const sts =
                            newHotel.status == "active" ? "disactive" : "active"
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className="border focus:bg-white w-full placeholder:italic placeholder:text-slate-400 block bg-gray-50 h-40 border-slate-300 rounded-lg py-4 px-3 shadow-sm focus:outline-none focus:border-bgPrimary  focus:ring-bgPrimary  focus:ring-1 sm:text-sm resize-none "
